  ...
  return (
    <div className="animate-reveal text-left" style={{ fontFamily: "'Quicksand', sans-serif" }}>
      ...
      <div className="space-y-5 pt-0 pb-6">
        ...
        <div className="space-y-3 px-1">
          ...
          <div className="grid grid-cols-3 gap-2 pt-1 text-center">
            <div className="space-y-1">
              ...
              <p className="text-[14px] font-black text-on-surface">₹78,450</p>
              <span className="text-[9px] text-green-600 font-bold">↗ 12%</span>
            </div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-[14px] font-black text-on-surface">245</p>
              <span className="text-[9px] text-green-600 font-bold">↗ 8%</span>
            </div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-[14px] font-black text-on-surface">₹2,450</p>
              <span className="text-[9px] text-green-600 font-bold">↗ 15%</span>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4 px-1">
          ...
          <div className="space-y-2.5">
            <div className="bg-white border border-outline-variant/10 rounded-2xl p-4 flex items-center justify-between transition-all shadow-sm">
              ...
              <button onClick={() => setPreviewDoc('gst')} className="text-[12.5px] font-extrabold text-[#4f27e3] hover:underline cursor-pointer">View</button>
            </div>
            ...
            <div className="bg-white border border-outline-variant/10 rounded-2xl p-4 flex items-center justify-between transition-all shadow-sm">
              ...
              <button onClick={() => setPreviewDoc('pan')} className="text-[12.5px] font-extrabold text-[#4f27e3] hover:underline cursor-pointer">View</button>
            </div>
        ...
        <div className="space-y-4 px-1">
          ...
          <div className="grid grid-cols-2 gap-4 pt-1">
            <div className="space-y-1">
              <span className="text-[10px] font-bold text-on-surface-variant/70 tracking-widest uppercase">Aadhaar</span>
              <p className="text-[13px] font-black text-on-surface leading-none">•••• ••••</p>
              <p className="text-[14px] font-black text-on-surface">9444</p>
            </div>
            <div className="space-y-1">
              <span className="text-[10px] font-bold text-on-surface-variant/70 tracking-widest uppercase">Pan Card</span>
              <p className="text-[14px] font-black text-on-surface tracking-wider">AB••••••4F</p>
            </div>
          </div>
        </div>
      ...
      {previewDoc && createPortal(
        <div className="fixed inset-0 z-[200] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 transition-all duration-300">
            ...
            <div className="p-4 overflow-y-auto flex-1 flex flex-col items-center justify-center bg-gray-50">
              ...
              {previewDoc === 'gst' && (
                <div className="w-full bg-white border-[4px] border-double border-amber-850/25 p-3 rounded-xl shadow-md text-[9px] space-y-2.5 font-serif relative overflow-hidden select-none">
                  {/* Ashok emblem water-mark or crest placeholder */}
                  ...
                  <div className="pt-2 border-t flex justify-between items-center font-sans">
                    <div className="space-y-0.5">
                      <span className="text-[6.5px] text-gray-500 block">System Signature</span>
                      <span className="text-[7.5px] font-bold text-green-600 flex items-center gap-0.5">
                        <span className="material-symbols-outlined text-[9px]">verified</span>
                        Digitally Signed
                      </span>
                    </div>
                    <div className="w-8 h-8 border border-gray-300 rounded p-0.5 bg-gray-50 flex items-center justify-center">
