  ...
  return (
    <div className="animate-reveal text-left pb-[100px]">
      ...
      <div className="space-y-6 pt-1">
        ...
        {/* Rating Summary Card */}
        <div className="bg-white p-4 sm:p-5 rounded-2xl border border-outline-variant/10 shadow-[0_2px_10px_rgba(0,0,0,0.02)] space-y-4">
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-5">
            <div className="text-center w-full sm:w-24 shrink-0">
              <h2 className="text-[40px] sm:text-[44px] font-black text-on-surface leading-none tracking-tight">{avgRating}</h2>
